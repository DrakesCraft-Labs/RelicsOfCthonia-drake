...
public class ConfigManager {
    ...
    public <T> void initializeConfig(String itemNameSection, String settings, T val, String fileName)  {
        ...
        try{
            ...
            if (!customConfig.isConfigurationSection(itemNameSection)) {
                ...
                customConfig.save(new File(RelicsOfCthonia.getInstance().getDataFolder(), fileName + ".yml"));
    ...
    public JsonObject loadJson(String jsonName) {
        try {
            ...
            InputStream resource = RelicsOfCthonia.class.getResourceAsStream("/" + jsonName + ".json");
    ...
    public FileConfiguration getCustomConfig(String fileName) {
        ...
        File customConfigFile = new File(RelicsOfCthonia.getInstance().getDataFolder(), fileName + ".yml");
